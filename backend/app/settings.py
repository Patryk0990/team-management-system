...
SECRET_KEY = 'django-insecure-x6tv^uz&(i#y=qk6yfj2-b@+djfzw=d72s#8ms)+f5&_h*ox_0'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Team Management System API',
    'DESCRIPTION': 'Projekt dotyczący systemu zarządzania zespołem',
    'VERSION': '1.0.0',
